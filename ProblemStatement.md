...
|                          /      |      \                           |
|                         v       v       v                          |
|                 Trader Client 1  Trader Client 2  Market-Data Client 1 |
|                   (Process 1)      (Process 2)         (Process 3) |
+--------------------------------------------------------------------+

```

### 1.0.1 Exchange Server
...
### 1.0.8 Overall Communication Pattern
The resulting communication patterns are:


```

Trader Clients <--( requests / orders | responses / notifications )--> Exchange Server

Exchange Server --( market-data updates )--> MD1, MD2, MD3
...
The same update may be sent to multiple subscribed Market-Data Clients.
...
For this assignment, two orders are considered a match only if all of the following are true:
...
## 6.5 Experiment 5 (Optional, not mandatory) Multiple Clients and I/O Multiplexing
